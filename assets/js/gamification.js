...
export const BADGE_DEFS = [
  { id: "first_byte", name: "First Byte", group: "exploration" },
  { id: "local_explorer", name: "Local Explorer", group: "exploration" },
  { id: "food_pathfinder", name: "Food Pathfinder", group: "exploration" },
  { id: "city_sampler", name: "City Sampler", group: "exploration" },
  { id: "flavor_cartographer", name: "Flavor Cartographer", group: "exploration" },
  { id: "bay_area_foodie", name: "Bay Area Foodie", group: "exploration" },
  { id: "bytelist_legend", name: "ByteList Legend", group: "exploration" },
  { id: "trend_starter", name: "Trend Starter", group: "influence" },
  { id: "taste_influencer", name: "Taste Influencer", group: "influence" },
  { id: "menu_architect", name: "Menu Architect", group: "influence" },
  { id: "flavor_authority", name: "Flavor Authority", group: "influence" },
  { id: "food_critic", name: "Food Critic", group: "review" },
  { id: "flavor_analyst", name: "Flavor Analyst", group: "review" },
  { id: "dish_philosopher", name: "Dish Philosopher", group: "review" },
  { id: "boba_connoisseur", name: "Boba Connoisseur", group: "category" },
  { id: "boba_cartographer", name: "Boba Cartographer", group: "category" },
  { id: "spice_seeker", name: "Spice Seeker", group: "category" },
  { id: "dessert_hunter", name: "Dessert Hunter", group: "category" },
  { id: "ramen_master", name: "Ramen Master", group: "category" },
  { id: "niche_foodie", name: "Niche Foodie", group: "category" },
  { id: "menu_hacker", name: "Menu Hacker", group: "special" },
  { id: "flavor_scientist", name: "Flavor Scientist", group: "special" },
  { id: "hidden_gem_hunter", name: "Hidden Gem Hunter", group: "special" },
  { id: "perfect_plate", name: "Perfect Plate", group: "special" },
  { id: "speed_reviewer", name: "Speed Reviewer", group: "special" },
  { id: "bytelist_pioneer", name: "ByteList Pioneer", group: "special" }
];
